    ...
    <div className="min-h-screen bg-gradient-to-br from-yellow-50 via-white to-yellow-50">
      ...
      <header className="bg-white shadow-sm">
        <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
          <div className="flex items-center gap-2">
            <img src="/images/logoHeader.png" alt="LearnLoom Logo" className="w-14 h-14" />
            <h1 className="text-2xl font-bold text-gray-800">LearnLoom</h1>
          </div>
      ...
      <main className="max-w-7xl mx-auto px-4 py-20">
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          ...
          <div className="flex justify-center">
            <img src="/images/logoHeroSection.png" alt="LearnLoom Hero" className="w-full max-w-lg" />
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 mt-20">
          <div className="bg-white rounded-2xl shadow-xl p-8 hover:shadow-2xl transition-shadow">
            ...
            <ul className="text-gray-600 space-y-2">
              <li className="flex items-center gap-2"><Check className="w-5 h-5 text-green-600" /> Access hundreds of courses</li>
              <li className="flex items-center gap-2"><Check className="w-5 h-5 text-green-600" /> Learn at your own pace</li>
              <li className="flex items-center gap-2"><Check className="w-5 h-5 text-green-600" /> Complete courses</li>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 hover:shadow-2xl transition-shadow">
            ...
            <ul className="text-gray-600 space-y-2">
              <li className="flex items-center gap-2"><Check className="w-5 h-5 text-green-600" /> Create valuable courses</li>
              <li className="flex items-center gap-2"><Check className="w-5 h-5 text-green-600" /> Reach global audience</li>
              <li className="flex items-center gap-2"><Check className="w-5 h-5 text-green-600" /> Track student engagement</li>
      ...
      <footer className="bg-gray-800 text-white mt-20 py-8">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <p>&copy; 2026 LearnLoom. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
